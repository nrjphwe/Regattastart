...
def start_video_recording(camera, video_path, file_name):
    ...
    logger.info ("  Line 116: Started viceo recording of %s ", file_name)
...
def start_sequence(camera, start_time_sec, num_starts, dur_between_starts, photo_path,):
    for i in range(num_starts):
        ...
        time_intervals = [
            (start_time_sec - 5 * (60 - 1.5), lambda: trigger_relay('Lamp1_on'), "5_min Lamp-1 On -- Up with Flag O"),
            (start_time_sec - 5 * 60, lambda: trigger_relay('Signal'), "5_min Warning signal"),
            (start_time_sec - 4 * (60 - 1.5), lambda: trigger_relay('Lamp2_on'), "4_min Lamp-2 On"),
            (start_time_sec - 4 * 60, lambda: trigger_relay('Signal'), "4_min Warning signal"),
            (start_time_sec - 1 * (60 - 1.5), lambda: trigger_relay('Lamp2_off'), "1_min Lamp-2 off -- Flag P down"),
            ...
            (start_time_sec, lambda: trigger_relay('Signal'), "Start signal"),
        ]
