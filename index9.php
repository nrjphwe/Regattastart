                    ...
                    <div class="w3-pale-yellow" style="text-align: center;">
                        <fieldset>
                            ...
                            <?php
                                ...
                                $current = time(); 
                                echo "Line 154: current = ", date("l H:i:s", $current), "<p>";
                                
                                $nearest_time = ceil($current / 300) * 300; // Find the nearest time in 5-minute intervals
                                echo "Line 157 nearest_time: ", date("l H m s",$nearest_time), "<p> ";

                                $start_time_option = date('H:i', $nearest_time);
                                echo "Line 160: start_time_option: ", $start_time_option, "<p>";
