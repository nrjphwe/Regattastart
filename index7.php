...
<div align="center">
<?php
// output index7.php was last modified.
$filename = 'index7.php';
...
<!-- Here is our main header that is used across all the pages of our website -->
<header>
<form method="post" action = "/cgi-bin/select_data7.py" name='myform'>
...
<option <?php if(isset($video_delay) && $video_delay == "100"){echo "selected=\"selected\"";} ?> value="100">100</option>
<option <?php if(isset($video_delay) && $video_delay == "120"){echo "selected=\"selected\"";} ?> value="120">120</option>
<option <?php if(isset($video_delay) && $video_delay == "140"){echo "selected=\"selected\"";} ?> value="140">140</option>
<option <?php if(isset($video_delay) && $video_delay == "160"){echo "selected=\"selected\"";} ?> value="160">160</option>
<option <?php if(isset($video_delay) && $video_delay == "180"){echo "selected=\"selected\"";} ?> value="180">180</option>
<option <?php if(isset($video_delay) && $video_delay == "200"){echo "selected=\"selected\"";} ?> value="200">200</option>
<option <?php if(isset($video_delay) && $video_delay == "220"){echo "selected=\"selected\"";} ?> value="220">220</option>
</select>
<p></p>
